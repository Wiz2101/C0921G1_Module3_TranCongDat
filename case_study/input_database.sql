...
values (ma_dich_vu,ten_dich_vu,dien_tich,chi_phi_thue,so_nguoi_toi_da,tieu_chuan_phong,mo_ta_tien_nghi_khac,dien_tich_ho_boi,so_tang,ma_kieu_thue,ma_loai_dich_vu),
(1,'Villa Beach Front',25000,1000000,10,'vip','Có hồ bơi',500,4,3,1),
(2,'House Princess 01',14000,500000,7,'vip','Có thêm bếp nướng',null,3,2,2),
...
(6,'Room Twin 02',3000,90000,2,'normal','Có tivi',null,null,4,3);
