...
public class CustomerRepository implements ICustomerRepository {
    ...
    private static final String INSERT_NEW_CUSTOMER_SQL = "INSERT INTO customer (customer_id_name,customer_type_id,customer_name,customer_birthday,customer_gender,customer_id_card,customer_phone,customer_email,customer_address,customer_status) VALUES (?,?,?,?,?,?,?,?,?,1)";
    ...
    private static final String UPDATE_CUSTOMER_BY_ID_SQL = "UPDATE customer SET customer_id_name= ?, customer_type_id= ?, customer_name= ?, customer_birthday= ?, customer_gender= ?, customer_id_card= ?, customer_phone= ?, customer_email= ?, customer_address= ? WHERE customer_id = ?";
    ...
    public void createCustomer(Customer customer) throws SQLException {
        try {
            ...
            preparedStatement.setString(1,customer.getCustomerIdName());
            ...
            preparedStatement.setInt(5, Integer.parseInt(customer.getCustomerGender()));
    ...
    public List<Customer> searchByName(String keyword) {
        ...
        try {
            ...
            ResultSet rs = preparedStatement.executeQuery();
            while (rs.next()){
                customerList.add(new Customer(rs.getInt("customer_id"),rs.getString("customer_id_name"),new CustomerType(rs.getInt("customer_type_id")),rs.getString("customer_name"),rs.getString("customer_birthday"),rs.getString("customer_gender"),rs.getString("customer_id_card"),rs.getString("customer_phone"),rs.getString("customer_email"),rs.getString("customer_address")));
            }
        } catch (SQLException e){
            printSQLException(e);
        }
