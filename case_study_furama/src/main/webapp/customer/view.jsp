            ...
            <div style="padding: 40px 25px" class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <a href="/customer?action=create" class="btn btn-success"><i class="far fa-plus-square"></i><span>Add New Employee</span></a>
                ...
                <table id="customerTable" class="table table-striped table-hover">
                    ...
                    <c:forEach var="customerList" items="${customerList}">
                        <tr>
                            ...
                            <td><c:out value="${customerList.customerIdCard}"></c:out></td>
                            <td><c:out value="${customerList.customerType.customerTypeName}"></c:out></td>
                            <td><c:out value="${customerList.customerPhone}"></c:out></td>
                            <td><c:out value="${customerList.customerEmail}"></c:out></td>
                            <td><c:out value="${customerList.customerAddress}"></c:out></td>
                            <td>
                                <a href="/customer?action=edit&id=${customerList.customerId}" class="btn btn-success btn-edit"><i class="btn fas fa-edit"></i></a>

                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#deleteModal-${customerList.customerId}">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="deleteModal-${customerList.customerId}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Are you sure to remove the customer with ID: ${customerList.customerId} & Name: ${customerList.customerName}?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                        <a href="/customer?action=delete&id=${customerList.customerId}" class="delete"><button type="button" class="btn btn-primary">Delete Now</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
