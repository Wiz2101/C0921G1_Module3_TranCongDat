...
<div class="container">
    ...
    <form class="well form-horizontal" method="post" id="contact_form">
        <fieldset>
            ...
            <!-- Form Name -->
            <legend>
                <center><h2><b>Service Edit Form</b></h2></center>
            </legend>
            <br>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input name="serviceName" value="${service.serviceName}" placeholder="Service Name" class="form-control" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input name="serviceArea" value="${service.serviceArea}" placeholder="Service Area" class="form-control" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input name="serviceCost" value="${service.serviceCost}" placeholder="Service Cost" class="form-control" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input name="serviceMaxPeople" value="${service.serviceMaxPeople}" placeholder="Service Max People" class="form-control"
                               type="text">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        ...
                        <select name="rentType" class="form-control">
                            <option value="${service.rentType.rentTypeId}" selected>${service.rentType.rentTypeName}</option>
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        ...
                        <select name="serviceType" class="form-control">
                            <option value="${service.serviceType.serviceTypeId}" selected>${service.serviceType.serviceTypeName}</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input name="standardRoom" value="${service.standardRoom}" placeholder="Standard Room" class="form-control" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input name="otherDiscription" value="${service.descriptionOtherConvenience}" placeholder="Other Description Service" class="form-control"
                               type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input name="poolArea" value="${service.poolArea}" placeholder="Pool Area" class="form-control" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input name="numberOfFloors" value="${service.numberOfFloors}" placeholder="Number of Floors" class="form-control" type="text">
                    </div>
                </div>
            </div>
